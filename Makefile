...
debug: MitoGraphGeo.cpp
	@$(CC) $(DFLAG) $(CFLAGS) MitoGraphGeo.cpp -o MitoGraphGeo $(VTK_DYN_LIBS) $(IGRAPH_DYN_LIBS) -I$(VTK_INCLUDE_DIR) -I$(IGRAPH_INCLUDE_DIR)

dynamic: MitoGraphGeo.cpp
	@$(CC) $(CFLAGS) MitoGraphGeo.cpp -o MitoGraphGeo $(VTK_DYN_LIBS) $(IGRAPH_DYN_LIBS) -I$(VTK_INCLUDE_DIR) -I$(IGRAPH_INCLUDE_DIR)

static:
	@$(CC) $(CFLAGS) MitoGraphGeo.cpp -o MitoGraphGeo $(VTK_STA_LIBS) $(IGRAPH_STA_LIBS) -I$(VTK_INCLUDE_DIR) -I$(IGRAPH_INCLUDE_DIR)